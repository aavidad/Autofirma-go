...
- Inventario de ejecutables, scripts y áreas: `docs/INVENTARIO_PROYECTO.md`
...
## Inventario y trazabilidad del proyecto
- Para regenerar el inventario funcional (scripts, ejecutables, áreas del repo) y el manifiesto completo de archivos:
```bash
