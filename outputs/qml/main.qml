                            ...
                            ScrollView {
                                ...
                                RowLayout {
                                    ...
                                    Button {
                                        ...
                                        font.pixelSize: 12
                                        onClicked: {
                                            // Intercambio directo de pixeles primero, garantizando cambio visual
                                            let temp = sealRect.width;
                                            sealRect.width = sealRect.height;
                                            sealRect.height = temp;
                                            // Computar la nueva proporción y resincronizar visualmente límites
                                            syncSealFromPreview();
                                            syncPreviewFromSeal();
                                        }
                                    }
                        ...
                        ColumnLayout {
                            ...
                            ListView {
                                ...
                                delegate: Rectangle {
                                    ...
                                    MouseArea { anchors.fill: parent; onClicked: { selectedCertIndex = index; window.selectedCertData = modelData; } }
                                }
                            }
                                ...
                                ColumnLayout {
                                    ...
                                    ScrollView {
                                        ...
                                        ColumnLayout {
                                            ...
                                            property var certInfo: window.selectedCertData

                                            Text { text: "<b>Titular:</b> " + (certInfo ? certInfo.subjectName : ""); color: "white"; font.pixelSize: 11; wrapMode: Text.Wrap; Layout.fillWidth: true }
                                            Text { text: "<b>Emisor:</b> " + (certInfo ? certInfo.issuerName : ""); color: "white"; opacity: 0.8; font.pixelSize: 11; wrapMode: Text.Wrap; Layout.fillWidth: true }
                                            Text { text: "<b>Nº Serie:</b> " + (certInfo ? certInfo.serialNumber : ""); color: "white"; opacity: 0.8; font.pixelSize: 10; wrapMode: Text.Wrap; Layout.fillWidth: true }
                                            Text { text: "<b>Uso:</b> " + (certInfo ? (certInfo.source === "system" ? "Almacén local" : (certInfo.source === "smartcard" ? "Tarjeta (DNIe / Crypto)" : certInfo.source)) : ""); color: "white"; opacity: 0.8; font.pixelSize: 10; wrapMode: Text.Wrap; Layout.fillWidth: true }
                                            Text { text: "<b>Expedición:</b> " + (certInfo ? certInfo.validFrom : ""); color: "white"; opacity: 0.8; font.pixelSize: 10; wrapMode: Text.Wrap; Layout.fillWidth: true }
                                        }
                                    }
